...
namespace Jcsms
{
    ...
    public class SmsService
    {
        ...
        /// <returns></returns>
        public SendSmsCodeResult SendSmsCode(string phoneNumber, string scope, string code, string content)
        {
            ...
            else
            {
                ...
                var sentRet = DefaulfSmsSender.SendCode(phoneNumber, code, scope, content, null);
